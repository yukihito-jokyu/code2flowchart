...
def get_flowchart_service() -> FlowchartService:
    ...
    return FlowchartService(api_key=AZURE_OPENAI_API_KEY, endpoint=AZURE_OPENAI_ENDPOINT, api_version=AZURE_OPENAI_API_VERSION, deployment_name=AZURE_OPENAI_DEPLOYMENT_NAME)
