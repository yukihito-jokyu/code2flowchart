...
export const useFlowchart = ({ projectId, initialData }: UseFlowchartProps) => {
  ...
  const dummyData: FlowchartData = {
    ...
    edges: [
      ...
      { id: 'e4-6', source: '4', target: '6', type: 'step', animated: true },
      ...
      { id: 'e13-14', source: '13', target: '14', type: 'step', animated: true },
      { id: 'e14-15', source: '14', target: '15', type: 'step', animated: true }, // whileループの最終処理→終了へ
      { id: 'e15-16', source: '15', target: '16', type: 'step', animated: true }, // while終了後の処理
    ],
  };
